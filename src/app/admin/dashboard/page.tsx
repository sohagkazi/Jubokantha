    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+180 new donors this week</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">3 projects nearing target</p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            <CardTitle>Income vs Expense (This Year)</CardTitle>
          </CardHeader>
                ...
                <div key={i} className="flex items-center">
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">
                      New Auto-Donation Received
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Rahim Uddin donated ৳500 via bKash.
                    </p>
                  </div>
